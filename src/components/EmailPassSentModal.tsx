    ...
    if (sendStatus === 'sending') return (
      <div className="bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900 p-3 rounded-none flex items-center gap-2.5">
        ...
        <div>
          ...
          <p className="text-[10px] text-blue-700 dark:text-blue-300">Menembak via Multi-Channel Gateway NAWALA JATI (Mode Prioritas Brevo / Fallback)</p>
        </div>
      </div>
    );
            ...
            <div className="space-y-1 text-[11px]">
              ...
              <div className="grid grid-cols-4 gap-1">
                ...
                <span className="col-span-3 font-bold text-[#005DA6] dark:text-[#FFD500]">
                  [NAWALA JATI PLN UIK TJB] Persetujuan Janji Temu &amp; Pass Digital - {visitor.visitorName}
                </span>
              </div>
            </div>
