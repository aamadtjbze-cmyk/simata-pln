...
import { Calendar, User, Building, Phone, Mail, UserCheck, Clock, FileText, Send, CheckCircle, ShieldCheck, Info } from 'lucide-react';
...
const PLN_DIVISIONS = [
  ...
  'BIDANG ENGINERING & LOGISTIK',
  'MANAJER PLN UIK TANJUNG JATI B',
  'DIVISI SDM & KEUANGAN',
